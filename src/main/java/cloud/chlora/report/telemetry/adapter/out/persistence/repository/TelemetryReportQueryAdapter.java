package cloud.chlora.report.telemetry.adapter.out.persistence.repository;
...
public class TelemetryReportQueryAdapter implements TelemetryReportRepository {
    ...
    private static final String BASE_FROM = """
            ...
            WHERE t.is_valid IS TRUE
              AND t.received_at >= :dateFrom
              AND t.received_at <  :dateTo
    ...
    public List<TelemetryReport> findAll(TelemetryReportQuery query) {
        String sql = """
                SELECT
                    p.pot_name,
                    d.device_name,
    ...
    @Override
    @Transactional(readOnly = true)
    public long countAll(TelemetryReportQuery query) {
    ...
    private TelemetryReport toReport(Object[] row) {
        return TelemetryReport.builder()
